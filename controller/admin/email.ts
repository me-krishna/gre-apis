...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="en">
 <head>
  ...
  <title>New email template 2024-06-11</title><!--[if (mso 16)]>
    <style type="text/css">
...
@media only screen and (max-width:600px) {.img-1053 { width:70px!important } .img-8739 { width:211px!important } .es-text-7750, .es-text-7750 p, .es-text-7750 a, .es-text-7750 h1, .es-text-7750 h2, .es-text-7750 h3, .es-text-7750 h4, .es-text-7750 h5, .es-text-7750 h6, .es-text-7750 ul, .es-text-7750 ol, .es-text-7750 li, .es-text-7750 span, .es-text-7750 sup, .es-text-7750 sub, .es-text-7750 u, .es-text-7750 b, .es-text-7750 strong, .es-text-7750 em, .es-text-7750 i { font-size:16px!important } .es-text-7750 .es-text-mobile-size-16, .es-text-7750 .es-text-mobile-size-16 * { font-size:16px!important; line-height:150%!important } }
                 ...
                 <tr>
                  <td class="es-m-p0r" valign="top" align="center" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-radius:1px" role="presentation">
                     <tr>
                      <td align="center" style="padding:0;Margin:0;font-size:0px"><a target="_blank" href="https://drrajus.com/" style="mso-line-height-rule:exactly;text-decoration:underline;color:#3D7781;font-size:14px"><img src="https://ehaopzd.stripocdn.email/content/guids/CABINET_e63654739b63a1d80cfda3c536ae6b2a08d2ec3ce698d2c7696b07b75d8c4cff/images/androidchrome512x512.png" alt="Logo" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none" width="120" title="Logo" class="img-1053"></a></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
                 ...
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:558px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     ...
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-right:15px;font-size:0px"><img class="img-8739" src="https://ehaopzd.stripocdn.email/content/guids/CABINET_e63654739b63a1d80cfda3c536ae6b2a08d2ec3ce698d2c7696b07b75d8c4cff/images/pngwingcom.png" alt="" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none" width="220"></td>
                     </tr>
                   </table></td>
                 </tr>
                 <tr>
